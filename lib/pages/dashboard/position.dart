                              ...
                              children: List.generate(
                                ...
                                (index) {
                                  ...
                                  if (socketData != null && socketData['instrument_token'] == instrumentToken) {
                                    lastPrice = num.parse(socketData['last_price'].toString());
                                    final openPrice = num.parse(data.openPrice.toString());
                                    ...
                                    if (pp.companyName == "NESTA CAPITAL") {
                                      pnl = (priceDiff * quantity * multiplier) - num.parse(data.brokerage.toString());
                                      pnlText = pnl.toStringAsFixed(2);
                                      percentChange = openPrice > 0 ? (pnl / (openPrice * quantity * multiplier)) * 100 : 0;
                                      percentText = "${percentChange.toStringAsFixed(2)}%";
                                    } else {
                                      pnl = priceDiff * quantity * multiplier;
                                      pnlText = pnl.toStringAsFixed(2);
                                      percentChange = openPrice > 0 ? (priceDiff / openPrice) * 100 : 0;
                                      percentText = "${percentChange.toStringAsFixed(2)}%";
                                    }
